...
<div data-role="page">
	...
	<div data-role="content">
		...
		<button data-type="button" onclick="chooseDifficulty(<?php echo $game_id . ", " . $user_id; ?>, 1);">Easy (2000 pts)</button>
		<button data-type="button" onclick="chooseDifficulty(<?php echo $game_id . ", " . $user_id; ?>, 2);">Medium (2500 pts)</button>
		<button data-type="button" onclick="chooseDifficulty(<?php echo $game_id . ", " . $user_id; ?>, 3);">Hard (3000 pts)</button>
	</div><!-- /content -->
